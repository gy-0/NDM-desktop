...
To reuse an installed Chromium browser without downloading another copy, set `NDM_QA_BROWSER` to its executable path. The tests still launch a separate temporary headless profile; they never attach to the user's browser session.
