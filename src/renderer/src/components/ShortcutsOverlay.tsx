  ...
  return (
    ...
    >
      <div
        ...
        aria-modal="true"
        aria-label="键盘快捷键"
        className={`t-modal max-h-full w-[min(520px,100%)] overflow-y-auto rounded-xl border border-line-strong bg-raised shadow-dialog scroll-quiet ${closing ? 'is-closing' : 'is-open'}`}
